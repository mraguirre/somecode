...
of the file (line by line) all in upper case. Executing the program will look as follows:
...
these lines. When you reach the end of the file, print out the average spam confidence.
...
Modify the program that prompts the user for the file name so that it prints
...
try:
    ...
    for line in handle:
        if line.startswith('X-DSPAM-Confidence:'):
            count = count + 1
    print('There were {} subject lines in {}'.format(count, filename))
except:
